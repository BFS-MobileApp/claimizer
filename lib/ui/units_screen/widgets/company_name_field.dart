...
class CompanyNameField extends StatelessWidget {
  const CompanyNameField({Key? key,required this.provider}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return Consumer<UnitProvider>(
      builder: (context, pr, child) => Container(
        ...
        child: TextFormField(
          controller: TextEditingController(text: pr.isBuilding? pr.linkListRequestDataBean.company: pr.newLinkRequestDataBean.company),
          readOnly: true,
