...
import 'package:Cliamizer/res/size_utils.dart';
import 'package:Cliamizer/ui/claims_details_screen/widgets/time_line.dart';
import 'package:Cliamizer/ui/claims_details_screen/widgets/time_line_painter.dart';
        ...
        child: Column(
          children: [
            Padding(
              ...
              child: ClaimizerAppBar(title: S.of(context).History),
            ),
            // SizedBox(
            //   height: 30.h,
            // ),
            // AppBarItem(title: 'history'),
            _buildCustomTabBar(),
            Expanded(
              child: TabBarView(
  ...
  Widget _buildCustomTabBar() {
    return Padding(
      ...
      child: TabBar(
        ...
        labelColor: MColors.primary_color,
        unselectedLabelColor: Colors.black12,
        tabs: [
          _buildTab(S.of(context).timeline, 0),
          _buildTab(S.of(context).workingHours, 1),
          _buildTab(S.of(context).staff, 2),
        ],
      ),
    );
  }
