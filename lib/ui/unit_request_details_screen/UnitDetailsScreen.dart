...
class UnitRequestDetailsScreenState extends BaseState<UnitRequestDetailsScreen, UnitDetailsPresenter>
  ...
  UnitDetailsProvider provider = UnitDetailsProvider();
  ...
  final invalidStatuses = ["rejected", "canceled", "terminated", "مفسوخ", "مرفوض", "ملغي"];
                  ...
                  child: ListView(children: [
                    ...
                    Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          AppHeadline(title: pr.instance?.refCode ?? S.current!.na),
                          Gaps.vGap30,
                          ItemWidget(
                          ...
                          ItemWidget(
                            title: S.current!.contractNo,
                            value: pr.instance!.contractNumber ?? S.current!.na,
                          ),
                          ItemWidget(
                          ...
                          Gaps.vGap12,
                          Gaps.vGap12,
                          !invalidStatuses.contains(pr.instance?.status?.toLowerCase())
                              ? ElevatedButton(
                            onPressed: (){},
                            style: ElevatedButton.styleFrom(
                                backgroundColor: MColors.primary_color
                                                  ...
                                                  return GestureDetector(
                                                      ...
                                                      child: Container(
                                                        ...
                                                        child: Row(
                                                          ...
                                                          mainAxisAlignment: MainAxisAlignment.center,
                                                          children: [
                                                            pr.identityImg != null && pr.identityImg.path.isNotEmpty && File(pr.identityImg.path).existsSync()
                                                                ? ClipRRect(
                                                    ...
                                                    return GestureDetector(
                                                        ...
                                                        child: Container(
                                                          ...
                                                          child: Row(
                                                            ...
                                                            mainAxisAlignment: MainAxisAlignment.center,
                                                            children: [
                                                              pr.identityImg != null && pr.identityImg.path.isNotEmpty
                                                                  ? ClipRRect(
                                                                  borderRadius: BorderRadius.circular(12),
                                                                  child: Image.file(
                                                                    pr.identityImg,
