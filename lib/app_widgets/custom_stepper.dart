              ...
              style: ButtonStyle(
                foregroundColor: MaterialStateProperty.resolveWith<Color>((Set<MaterialState> states) {
                  if (states.contains(MaterialState.disabled)) {
                    return Colors.transparent; // Or any other color for disabled state
                  } else {
                    return _isDark() ? colorScheme.onSurface : colorScheme.onPrimary;
                  }
                }),
                backgroundColor: MaterialStateProperty.resolveWith<Color>((Set<MaterialState> states) {
                  if (_isDark() || states.contains(MaterialState.disabled)) {
    ...
    return Column(
      ...
      children: <Widget>[
        AnimatedDefaultTextStyle(
          style: _titleStyle(index)??TextStyle(),
          duration: kThemeAnimationDuration,
          curve: Curves.fastOutSlowIn,
        ...
        if (widget.steps[index].subtitle != null)
          Container(
            ...
            child: AnimatedDefaultTextStyle(
              style: _subtitleStyle(index)??TextStyle(),
              duration: kThemeAnimationDuration,
              curve: Curves.fastOutSlowIn,
              child: widget.steps[index].subtitle??SizedBox(),
            ),
          ),
      ],
    );
  ...
  Widget _buildLabelText(int index) {
    if (widget.steps[index].label != null) {
      return AnimatedDefaultTextStyle(
        style: _labelStyle(index)??TextStyle(),
        duration: kThemeAnimationDuration,
        child: widget.steps[index].label??SizedBox(),
      );
    }
