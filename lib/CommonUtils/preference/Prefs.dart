...
class Prefs {
  ...
  static Future<void> setDeleteAccount(List<String> value) {
    String jsonString = json.encode(value);
    return PreferencesHelper.setString(Const.DELETE_ACC, jsonString);
  }

  static Future<List<String>> getDeleteAccount() async{
    List<String> myList = [];
    bool checkValue = await PreferencesHelper.checkKey(Const.DELETE_ACC);
    if(checkValue){
      String jsonString = await PreferencesHelper.getString(Const.DELETE_ACC);
      if (jsonString != null) {
