...
class DefaultSFDateRangePicker extends StatefulWidget {
  ...
  final DateRangePickerSelectionChangedCallback? onChanged; // Updated type
  final bool isFromCheckin;
  final bool toggleDaySelection;
  final DateRangePickerSelectionMode selectionMode;

  const DefaultSFDateRangePicker({Key? key,required this.blackOutDates,required this.onChanged,required this.selectionMode, this.weekendDays, this.isFromCheckin = false , this.selectedDates, this.toggleDaySelection = true}) : super(key: key);
